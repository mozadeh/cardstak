...
<title>Cardstak:Forgot Password</title>
...
<b style="color:#2B8BC0;font-size:32px">Network Better</b>-->
    ...
    <table style="width: 100%;text-align: center;">
        ...
        <tr >
            ...
            <h1 style="text-align: -webkit-center;margin-left: 0px;"><b>Reset Password</b></h1>
            	</td>
            </tr>
           <tr >
               <td>
	...
	<tr >
			...
			<input type="button" onclick="resetpasswordattempt();" value="Change" name="change" style="float: none;"/>
		</td>
         </tr>
...
<script src="js/jscript.forgotpassword.js" type="text/javascript"> </script>
