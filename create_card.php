...
<head>
  ...
  <link href='http://fonts.googleapis.com/css?family=Pathway+Gothic+pne' rel='stylesheet' type='text/css'>
...
$createurl="create_card.php"."?event_id=".$event_id;
 ...
 if(empty($_SESSION['user'])) 
	...
	while (ob_get_status()) 
	{
        ...
        echo "<script>window.location = 'http://www.cardstak.com/login.php'</script>";
    }
 ...
 $_SESSION['location']=$createurl;
    ...
    $ntitle=substr(htmlentities($_SESSION['user']['title'], ENT_QUOTES, 'UTF-8'),0,35)?: '';  
    $stitle=substr(htmlentities($_SESSION['user']['title'], ENT_QUOTES, 'UTF-8'),0,35)?: 'Student, UC Berkeley';  
    $spicurl=htmlentities($_SESSION['user']['picurl'], ENT_QUOTES, 'UTF-8')?: 'http://cardstak.com/uploads/profileimage.png'; 
    if($spicurl=='undefined') $spicurl='http://cardstak.com/uploads/profileimage.png';
    $slinkedinurl=htmlentities($_SESSION['user']['linkedinurl'], ENT_QUOTES, 'UTF-8')?: '';  
    $nbio=htmlentities($_SESSION['user']['bio'], ENT_QUOTES, 'UTF-8') ?: '';   
    $sbio=htmlentities($_SESSION['user']['bio'], ENT_QUOTES, 'UTF-8') ?: $defaultbio;
    $biolength=strlen($sbio);
    $sbio=substr($sbio,0,min(350,$biolength));
    if ($biolength>350) {$sbio="$sbio...";}
    //$nbio=$sbio ?: '';
    $nbio=htmlentities($_SESSION['user']['bio'], ENT_QUOTES, 'UTF-8') ? $sbio: '';   
    ...
    $sfullname= substr($firstname,0,$firstlength).' '.substr($lastname,0,$cutlastlenght);  
...
<table style="border-spacing:0px; padding-top:0px;padding-top:4%;display:none;" id="createtable"  align="center">
  				...
  				<td></td>            
					...
					<img src="images/ajax-loader.gif" id="loading-img" style="display:none;float:right" alt="Please Wait"/>
	                        ...
	                        <tr class="inputstyle">
		                                ...
		                                <label id="g1buttonback" style="display:block;"><input type="radio" name="group" value="1" /><span id="g1button" class="radioitem"></span></label>
						
						<label id="g2buttonback" style="display:block;"><input type="radio" name="group" value="2" /><span id="g2button" class="radioitem"></span></label>
						
						<label id="g3buttonback" style="display:block;"><input type="radio" name="group" value="3"  /><span id="g3button" class="radioitem"></span></label>
						</td>
	                        ...
	                        <div id="loaderdiv" align="center"><img src="images/loader.gif" id="loadergif" alt="Please Wait"/></div>    
                                ...
                                <tr>
                                    ...
                                    <td style="height:33px">
                                    	<div id="output1">
                                        	<input id="formcv" type="text" style="width:230px;display:none" placeholder="www.dropbox.com/mycv.pdf" /> 
                                        </div> 
						...
						<div id="progressbox" ><div id="progressbar"></div ><div id="statustxt">0%</div></div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id="formphone" type="text" class="inputform" placeholder="123-456-7890" />
                                    </td>
		                    ...
		                    <tr>
			                      <td style="padding-right: 30px;padding-bottom:20px;padding-left: 30px;" align="center">
			                          <input type="button" id="submitbutton" onclick="myFunction()" align="center" value="Submit Card">
			                      </td>
							
							
			                      <td style="padding-bottom:20px;margin-left: 10px;" align="center">
			                            <input type="button" onclick="goBack()" align="center" value="Cancel"> 
...
<script type="text/javascript" src="js/jscript.newcard.js" > </script>
