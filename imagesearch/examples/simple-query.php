...
$query='Fereidoung Ghasemzadeh is CEO at Afranet';        
...
foreach ($results as $item) {
  echo serialize($item). "<br /> \n";
}*/

$image = $results[modelData][items][0][image][thumbnailLink];

if (empty($image)){$image= 'http://cardstak.com/uploads/profileimage.png';}

//print var_dump($image);

//print '<pre>'.print_r($results, true).'</pre>';
//print '<img src="'.print_r($results[modelData][items][0][link], true).'">';
print '<img src="'.$image.'">';
/************************************************
