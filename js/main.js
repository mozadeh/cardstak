...
//$('.parallax-window').parallax({imageSrc: '/images/loginbackground.jpg'});

(function(){
	"use strict";
	/*$(function(){
		setInterval(function () {document.getElementById('ftitle').style.opacity=1;
		document.getElementById('ftitle').style.filter="alpha(opacity=100)";}, 500);

		setInterval(function () {document.getElementById('fslogan').style.opacity=1;
		document.getElementById('fslogan').style.filter="alpha(opacity=100)";}, 1000);
		
		setInterval(function () {document.getElementById('fbutton').style.opacity=1;
		document.getElementById('fbutton').style.filter="alpha(opacity=100)";}, 1300);
	});*/
...
function openJoin(){
	document.getElementById("joindisplay").style.display = "";
	document.getElementById("joinbackground").style.display = "";
}

function closeJoin(){
	document.getElementById("joindisplay").style.display = "none";
	document.getElementById("joinbackground").style.display = "none";
}

function useEntryCode(){
	var stakcode = document.getElementById("entrycode").value; 
	var dataString = 'eventid=' + stakcode;
	...
	$.ajax({
		...
		success: function(result) {
			window.location='http://www.cardstak.com/index.php?event_id='+stakcode;

		},
		error: function (request, status, error) {
		        sweetAlert("Oops...", "No such Stak exists", "error");   
